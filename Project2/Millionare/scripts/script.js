    ...
    setInterval(() => {
        ...
        if (timer.textContent <0) {
            ...
            if (count<5){
                ...
                popup_content.textContent = `Нажаль, ${player_name}, ваш час вичерпано, гра закінчена. Ваш виграш складає 0 ₴.`
                ...
                popup_content.textContent = `Нажаль, ${player_name}, ваш час вичерпано, гра закінчена. Ваш виграш складає 1000 ₴.`
                popup.style.opacity = '1';
                popup.style.visibility = 'visible';
            } else {
                timer.textContent = '';
                ...
                popup_content.textContent = `Нажаль, ${player_name}, ваш час вичерпано, гра закінчена. Ваш виграш складає 32000 ₴.`
                popup.style.opacity = '1';
                popup.style.visibility = 'visible';
            }
    ...
    if (event.target == hints.children[0] && fifty_fifty){
        ...
        setTimeout(function(){
            ...
            if (answers.children[0].textContent==correct){
                ...
                popup_content.textContent = `Я абсолютно впевнений, що це відповідь ${answers.children[0].textContent[0]}`;
                popup.style.opacity = '1';
                popup.style.visibility = 'visible';
                ...
                popup_content.textContent = `Я абсолютно впевнений, що це відповідь ${answers.children[1].textContent[0]}`;
                popup.style.opacity = '1';
                popup.style.visibility = 'visible';
                hints.children[1].style.backgroundColor = '#e62e50'
                friend_call = false;
                ...
                popup_content.textContent = `Я абсолютно впевнений, що це відповідь ${answers.children[2].textContent[0]}`;
                popup.style.opacity = '1';
                popup.style.visibility = 'visible';
                hints.children[1].style.backgroundColor = '#e62e50'
                friend_call = false;
                ...
                popup_content.textContent = `Я абсолютно впевнений, що це відповідь ${answers.children[3].textContent[0]}`;
                popup.style.opacity = '1';
                popup.style.visibility = 'visible';
                hints.children[1].style.backgroundColor = '#e62e50'
                friend_call = false;
            ...
            if (count<5){
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                            ...
                            timer.style.opacity = '0';
                            timer.textContent = 6000000;
                            popup_content.textContent = `Нажаль, ${player_name}, це неправильна відповідь, гра закінчена. Ваш виграш складає 0 ₴.`
                            popup.style.opacity = '1';
                            popup.style.visibility = 'visible';
                    },900)
                },900)
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                            ...
                            timer.style.opacity = '0';
                            timer.textContent = 6000000;
                            popup_content.textContent = `Нажаль, ${player_name}, це неправильна відповідь, гра закінчена. Непогано для початку. Ваш виграш складає 1000 ₴.`
                            popup.style.opacity = '1';
                            popup.style.visibility = 'visible';
                    },900)
                },900)
                ...
                setTimeout(function(){
                    ...
                    setTimeout(function(){
                            ...
                            timer.style.opacity = '0';
                            timer.textContent = 6000000;
                            popup_content.textContent = `Нажаль, ${player_name}, це неправильна відповідь, гра закінчена. Чудовий результат! Ваш виграш складає 32000 ₴.`
                            popup.style.opacity = '1';
                            popup.style.visibility = 'visible';
                    },900)
                },900)
